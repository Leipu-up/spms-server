...
DROP TABLE IF EXISTS `jjcpbgl`;
CREATE TABLE `jjcpbgl` (
                           `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
                           `create_time` bigint(20) unsigned DEFAULT '0' COMMENT '创建时间',
                           `update_time` bigint(20) unsigned DEFAULT '0' COMMENT '修改时间',
                           `cpmc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '产品名称',
                           `cpxh` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '产品型号',
                           `cpbb` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '产品版本',
                           PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci  COMMENT='机加产品表管理';

DROP TABLE IF EXISTS `jjgxbgl`;
CREATE TABLE `jjgxbgl` (
                           `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
                           `create_time` bigint(20) unsigned DEFAULT '0' COMMENT '创建时间',
                           `update_time` bigint(20) unsigned DEFAULT '0' COMMENT '修改时间',
                           `gxmc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '工序名称',
                           `jjcpbgl_id` bigint(20) unsigned NOT NULL  COMMENT '机加产品表管理id',
                           PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci  COMMENT='机加工序表管理';

DROP TABLE IF EXISTS `jjgxxqbgl`;
CREATE TABLE `jjgxxqbgl` (
                           `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
                           `create_time` bigint(20) unsigned DEFAULT '0' COMMENT '创建时间',
                           `update_time` bigint(20) unsigned DEFAULT '0' COMMENT '修改时间',
                           ...
                           `pc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '频次',
                           `jjgxbgl_id` bigint(20) unsigned NOT NULL   COMMENT '机加工序表管理id',
                           PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci  COMMENT='机加工序详情表管理';
...
DROP TABLE IF EXISTS `jjgxjcb`;
CREATE TABLE `jjgxjcb` (
                           `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
                           `create_time` bigint(20) unsigned DEFAULT '0' COMMENT '创建时间',
                           `update_time` bigint(20) unsigned DEFAULT '0' COMMENT '修改时间',
                           ...
                           `jjgxbgl_id` bigint(20) unsigned NOT NULL  COMMENT '机加工序表管理id',
                           PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='机加工序检查表';

DROP TABLE IF EXISTS `jjgxjcjgb`;
CREATE TABLE `jjgxjcjgb` (
                           `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
                           `create_time` bigint(20) unsigned DEFAULT '0' COMMENT '创建时间',
                           `update_time` bigint(20) unsigned DEFAULT '0' COMMENT '修改时间',
                           `gjzt` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '工件状态(首件,工序检验,尾件)',
                           `jcsj` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '检查时间',
                           `scz` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '实测值',
                           `pdjg` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '判定结果(OK/NG)',
                           `bhepbg` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '不合格品报告',
...
INSERT INTO `permission` (`is_disabled`, `is_published`, `is_system`, `type`, `create_time`, `id`, `parent_id`, `update_time`, `name`, `identity`) VALUES (0, 0, 1, 0, 1765874181728, 347, 340, 1765874181728, '机加工序检查表-分页查询', 'Jjgxjcb_getPage');
INSERT INTO `permission` (`is_disabled`, `is_published`, `is_system`, `type`, `create_time`, `id`, `parent_id`, `update_time`, `name`, `identity`) VALUES (0, 0, 1, 0, 1765874181728, 348, 340, 1765874181728, '机加工序检查表-禁用', 'Jjgxjcb_disable');
INSERT INTO `permission` (`is_disabled`, `is_published`, `is_system`, `type`, `create_time`, `id`, `parent_id`, `update_time`, `name`, `identity`) VALUES (0, 0, 1, 0, 1765874181728, 349, 340, 1765874181728, '机加工序检查表-添加', 'Jjgxjcb_add');
...
INSERT INTO `permission` (`is_disabled`, `is_published`, `is_system`, `type`, `create_time`, `id`, `parent_id`, `update_time`, `name`, `identity`) VALUES (0, 0, 1, 0, 1765874181728, 447, 363, 1765874181728, '机加工序表管理-分页查询', 'Jjgxbgl_getPage');
INSERT INTO `permission` (`is_disabled`, `is_published`, `is_system`, `type`, `create_time`, `id`, `parent_id`, `update_time`, `name`, `identity`) VALUES (0, 0, 1, 0, 1765874181728, 448, 363, 1765874181728, '机加工序表管理-禁用', 'Jjgxbgl_disable');
INSERT INTO `permission` (`is_disabled`, `is_published`, `is_system`, `type`, `create_time`, `id`, `parent_id`, `update_time`, `name`, `identity`) VALUES (0, 0, 1, 0, 1765874181728, 449, 363, 1765874181728, '机加工序表管理-添加', 'Jjgxbgl_add');
...
INSERT INTO `permission` (`is_disabled`, `is_published`, `is_system`, `type`, `create_time`, `id`, `parent_id`, `update_time`, `name`, `identity`) VALUES (0, 0, 1, 0, 1765874181728, 547, 364, 1765874181728, '机加产品表管理-分页查询', 'Jjcpbgl_getPage');
INSERT INTO `permission` (`is_disabled`, `is_published`, `is_system`, `type`, `create_time`, `id`, `parent_id`, `update_time`, `name`, `identity`) VALUES (0, 0, 1, 0, 1765874181728, 548, 364, 1765874181728, '机加产品表管理-禁用', 'Jjcpbgl_disable');
INSERT INTO `permission` (`is_disabled`, `is_published`, `is_system`, `type`, `create_time`, `id`, `parent_id`, `update_time`, `name`, `identity`) VALUES (0, 0, 1, 0, 1765874181728, 549, 364, 1765874181728, '机加产品表管理-添加', 'Jjcpbgl_add');
