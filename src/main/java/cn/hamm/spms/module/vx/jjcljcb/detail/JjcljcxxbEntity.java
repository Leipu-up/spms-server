...
@DynamicInsert
@DynamicUpdate
@Table(name = "jjcljcxxb")
@Description("机加材料检查详情表")
public class JjcljcxxbEntity extends BaseEntity<JjcljcxxbEntity> {
	...
	@Description("检查项目")
	@Column(columnDefinition = "varchar(255) default '' comment '检查项目'")
	@NotBlank(groups = {WhenUpdate.class, WhenAdd.class}, message = "检查项目不能为空")
	@Search(fullLike = true)
	@Export
	private String jcxm;
	...
	@Column(columnDefinition = "bigint UNSIGNED comment '机加材料检查表id'")
